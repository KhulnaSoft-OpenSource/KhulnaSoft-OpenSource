...
<p align="center">
  ...
  <a href="https://github.com/khulnasoft-opensource/khulnasoft-opensource/actions/workflows/release.yml">
    <img src="https://github.com/khulnasoft-opensource/khulnasoft-opensource/actions/workflows/release.yml/badge.svg" alt="Release" style="max-width: 100%;">
  </a>
  <a href="https://github.com/khulnasoft-opensource/khulnasoft-opensource/actions/workflows/storybook.yml">
    <img src="https://github.com/khulnasoft-opensource/khulnasoft-opensource/actions/workflows/storybook.yml/badge.svg" alt="Publish stories if changed" style="max-width: 100%;">
  </a>
  <a href="https://app.netlify.com/sites/khulnasoft-opensource/deploys">
  ...
  <img src="https://img.shields.io/github/languages/code-size/khulnasoft-opensource/khulnasoft-opensource" alt="GitHub code size in bytes">
  <img src="https://img.shields.io/github/commit-activity/w/khulnasoft-opensource/khulnasoft-opensource" alt="GitHub commit activity">
  <a href="https://github.com/khulnasoft-opensource/khulnasoft-opensource/issues">
    <img src="https://img.shields.io/github/issues/khulnasoft-opensource/khulnasoft-opensource" alt="GitHub issues">
  </a>
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/khulnasoft-opensource/khulnasoft-opensource)
...
KhulnaSoft OpenSource comes with a pre-defined [.gitpod.yml](./.gitpod.yml) that should work out of the box in multiple [contribution scenarios](https://www.gitpod.io/docs/references/gitpod-yml).
...
[![Open in Replit](https://repl.it/badge/github/khulnasoft-opensource/khulnasoft-opensource)](https://repl.it/github/khulnasoft-opensource/khulnasoft-opensource)
...
KhulnaSoft OpenSource is configured with a shell environment supporting node@16 and npm@8. The build environment script lives in [shell.nix](./shell.nix) and the [repl config](https://docs.replit.com/programming-ide/configuring-repl) lives in [.replit](./replit).
...
[![Open in CodeSandbox](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/khulnasoft-opensource/khulnasoft-opensource?fontsize=14&hidenavigation=1&theme=dark&previewwindow=console&runonclick=1)
...
[![Open in Stackblitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/khulnasoft-opensource/khulnasoft-opensource)
...
[![Remix on Glitch](./src/icons/remix-button.svg)](https://glitch.com/edit/#!/import/github/khulnasoft-opensource/khulnasoft-opensource)
...
```shell
docker build -t khulnasoft-opensource-dev .
docker run -p 8080:80 khulnasoft-opensource-dev
```

Alternatively you can pull the production container and skip all builds: 

```shell
docker run -dit -p 8080:80 ghcr.io/khulnasoft-opensource/khulnasoft-opensource
```
...
This project uses GitHub as a database. When you login, you will be presented with a button to create a goals repository. That repository template lives at [khulnasoft-opensource/goals-template](https://github.com/khulnasoft-opensource/goals-template).
