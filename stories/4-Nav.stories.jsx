...
export const HomePage = () => (
  <Fragment>
    <HomeNav>
      <FloatLeft>
        <a href="#">
          <img alt="khulnasoft opensource" src={logo} />
        </a>
        <ul>
          <li>
          ...
          <li>
            <SubtleLink className="nav-link" rel="noreferrer" target="_blank" href="https://github.com/khulnasoft-opensource/khulnasoft-opensource">GitHub</SubtleLink>
          </li>
          <li>
    ...
    <AppNav>
      <FloatLeft>
        ...
        <ul>
          ...
          <li>
            <SubtleLink className="nav-link" rel="noreferrer" target="_blank" href="https://github.com/khulnasoft-opensource/khulnasoft-opensource/issues/new/choose">
              Issue
            </SubtleLink>
          </li>
          <li>
