...
const repoInfo = [
  {
    repoOwner: "khulnasoft-opensource",
    repoName: "khulnasoft-opensource",
  ...
  return (
    <>
      <CreateGoalsContainer>
        ...
        <p>
          KhulnaSoft OpenSource is a tool to help track your open source contributions. You can get started by creating a goal
          workspace below.
        </p>
        <p>A public repository named "khulnasoft-opensource-goals" will be created on your GitHub account to store data about your goals.</p>
        <small>
      ...
      <ContextStyle>
        ...
        <Cards disabled={installReady || databaseCreated}>
          <SpaceBetween>
            <OnBoardingText>
              <h1>1</h1>
              <p>Let's sync KhulnaSoft OpenSource with your GitHub Repos</p>
            </OnBoardingText>
        ...
        <Cards disabled={!installReady || databaseCreated}>
          <SpaceBetween>
            <OnBoardingText>
              <h1>2</h1>
              <p>Now let's create the KhulnaSoft OpenSource database on GitHub</p>
            ...
            <a
              rel="noreferrer"
              target="_blank"
              href={`https://github.com/apps/khulnasoft-opensource/installations/new/permissions?target_id=${user && user.id}`}>
              <Button
