  ...
  return (
    <div>
      <ul>
        ...
        <li>
          <a href={`https://github.com/khulnasoft-opensource/khulnasoft-opensource/releases/tag/v${getAppVersion()}`} rel="noreferrer" target="_blank">
  ...
  return (
    <div>
      <ul>
        ...
        <li>
          <a href="https://github.com/search?o=desc&q=khulnasoft-opensource-goals&s=updated&type=Repositories" target="_blank" rel="noreferrer">
